...
const Vehicle = ({ vehicle }) => (
  <div className="card fixed-size-card d-inline-block" style={{ width: '18rem' }}>
    <img src={logostar} className="card-img-top" alt="Vehicle" />
    <div className="card-body">
      <h5 className="card-title">{vehicle.properties.name}</h5>
      <p className="card-text">
        Model: {vehicle.properties.model}<br />
        Manufacturer: {vehicle.properties.manufacturer}<br />
        Length: {vehicle.properties.length} meters<br />
        Max Speed: {vehicle.properties.max_atmosphering_speed}
      </p>
